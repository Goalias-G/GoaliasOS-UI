            ...
            <div class="text-center max-w-lg">
                ...
                <div class="mb-8 animate-float">
                    <div class="relative inline-block">
                        ...
                        <div class="absolute -bottom-4 -right-4 w-16 h-16 bg-clay-accent-pink/10 rounded-full blur-xl animate-breathe"
                ...
                <div class="clay-card p-8 mb-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 justify-center">
                        <button v-for="suggestion in suggestions" :key="suggestion.title" @click="suggestion.action"
